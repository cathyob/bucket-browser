...
/***/ function(module, exports, __webpack_require__) {
	...
	var restaurantEvents = __webpack_require__(12);
	var maps = __webpack_require__(35);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://feedbucketcathyob.herokuapp.com'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(function (response) {
	    store.user = response.user; // user that is logged in is now saved
	  }).then(ui.signInSuccess).catch(ui.signInFailure);
	};
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(function () {
	    delete store.user;
	    return store;
	  }).then(ui.signOutSuccess).catch(ui.signOutFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var restEvents = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onListRest = function onListRest(event) {
	  if (event !== undefined) {
	    event.preventDefault();
	  }

	  api.listRestaurant().then(function (response) {
	    store.restaurants = response.restaurants;
	    return store;
	  }).then(ui.displayRestforUser).catch(ui.failure);
	};

	var onCreateRest = function onCreateRest(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createRestaurant(data).then(function (response) {
	    // store.restaurant = response.restaurant; // restaurant is created is now saved
	  }).then(onListRest).then(ui.success).catch(ui.failure);
	};

	var achievedRest = function achievedRest(id) {
	  var data = {};
	  data.restaurant = {
	    "achieved": true
	  };
	  api.updateRestaurant(data, id).then(onListRest);
	};

	var deleteRest = function deleteRest(id) {
	  api.deleteRestaurant(id).then(onListRest);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onCreateRest: onCreateRest,
	  onListRest: onListRest,
	  achievedRest: achievedRest,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRestaurant = function createRestaurant(data) {
	  return $.ajax({
	...
	var listRestaurant = function listRestaurant() {
	  return $.ajax({
	    url: config.apiOrigin + '/restaurants',
	    method: 'GET',
	    headers: {
	...
	var updateRestaurant = function updateRestaurant(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/restaurants/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var restaurantList = __webpack_require__(15);
	var store = __webpack_require__(10);

	var displayRestforUser = function displayRestforUser(data) {
	  var events = __webpack_require__(12);
	  $('.restaurant-list').empty(); // empty in case it had already been requested
	  var html = restaurantList({ restaurants: data.restaurants });
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  displayRestforUser: displayRestforUser
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.achieved : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "  <div class=\"visited\">\n    <div class=\"visit-message restaurant-check-icon\">\n      Visited!\n    </div>\n    <div class=\"restaurant-trash-icon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <span class=\"glyphicon glyphicon-trash icon\" aria-hidden=\"true\"></span>\n    </div>\n    <div class=\"restaurant-selectable\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <p class=\"restaurant-name-style\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.name : stack1), depth0))
	    + "</p>\n      <p class=\"restaurant-location-style\"><span class=\"label\">Address: </span>"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.location : stack1), depth0))
	    + "</p>\n      <p class=\"restaurant-type-style\"><span class=\"label\">Type: </span>"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.type : stack1), depth0))
	    + "</p>\n      <p class=\"restaurant-notes-style\"><span class=\"label\">Notes: </span>"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.notes : stack1), depth0))
	    + "</p>\n    </div>\n  </div>\n\n";
	},"4":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "\n  <div class=\"pending\">\n    <div class=\"restaurant-check-icon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <span class=\"glyphicon glyphicon-check\" aria-hidden=\"true\"></span> Visited?\n    </div>\n    <div class=\"restaurant-trash-icon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.restaurants : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDataFromMaps = function getDataFromMaps(event) {
	  event.preventDefault();
	  var place = {};
